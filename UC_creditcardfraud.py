...
_input_file = "./inputData/UC_creditcardfraud_input.csv"
_output_model_directory = "./models/model_UC_creditcardfraud/"
...
model = Sequential()
model.add(Dense(40, input_dim=29, activation='relu'))
